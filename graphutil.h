...
std::set<vertex_t> 	          get_neighbors(vertex_t, Graph const&, Vert2UintMap&);
std::pair<vertex_t, vertex_t> get_intersection(std::set<vertex_t> const&, std::set<vertex_t> const&, Vert2UintMap&);
...
CycleCost compute_cycle_cost(std::vector<vertex_t> const& cycle, Graph const&, Vert2UintMap&, BFSVisitorData const&, EmbedStruct const&);
